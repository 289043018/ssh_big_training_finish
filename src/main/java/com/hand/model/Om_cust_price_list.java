...
public class Om_cust_price_list {
	...
	public Om_cust_price_list(int id, String cust_name, String type, String pL_YH_ITEM, Date effective_date_from,
			Date effective_date_to, String user_def1, String user_def2, String user_def3, String user_def4,
