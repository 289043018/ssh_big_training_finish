...
<div class="panel panel-info">
					...
					<div class="panel-body">
						<div class="table-responsive">
							<form class="form-horizontal" role="form" action="<%=request.getContextPath()%>/doNormalDiscount_update!update.do?" Method="post" name="loginForm">
                    
                     <s:iterator id="om_normal_discount" value="om_normal_discount">
										<tr class="success">
							<td>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" name="base_qty" value="${base_qty}"
											class="form-control" >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label">折扣率：</label>
                         <div class="col-md-4">
                            <input type="text" name="discount_rate" value="${discount_rate}"
											class="form-control" >
                        </div>
                    </div>
                     <div class="form-group">
