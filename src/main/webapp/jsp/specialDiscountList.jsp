			...
			<div class="kehuguanli">
				...
				<div class="panel panel-info">
					...
					<div class="panel-body">
						...
						<form action="<%=request.getContextPath() %>/doSpecialDiscount_query!query.do" Method="post" name="loginForm">
						<table class="table_bottom">
						      <tr>
						        <td align="center" >折扣名称: <input type="text" name="search"/> </td>
						        <td align="center" >客户代码: <input type="text" name="search1"/> </td>
						      </tr>
								<tr>
								...
								<tbody>
									...
									<s:iterator  value="om_special_discount_list">
										<tr class="success">
											...
											<td align="center" name="amount">${amount}</td>
											<td align="center" name="applied_amount">${applied_amount}</td>
											<td align="center" name="balance">${balance}</td>
