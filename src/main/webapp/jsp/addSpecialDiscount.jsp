				...
				<div class="panel panel-info">
					...
					<div class="panel-body">
						<div class="table-responsive">
							<form class="form-horizontal" role="form" action="<%=request.getContextPath() %>/doSpecialDiscount_add!add.do" Method="post" name="loginForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" name="cust_code" class="form-control" placeholder="Frist Name">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" name="amount" class="form-control" placeholder="Frist Name">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label">已用金额:</label>
                        <div class="col-md-4">
                            <input type="text" name="applied_amount" class="form-control" placeholder="Frist Name">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label">折扣余额:</label>
                        <div class="col-md-4">
                            <input type="text" name="balance" class="form-control" placeholder="Frist Name">
                        </div>
                    </div>
                    <div class="form-group">
